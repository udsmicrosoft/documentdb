...
#define ERRCODE_DOCUMENTDB_UNAUTHORIZED MAKE_SQLSTATE('M', '0', '0', 'E', 'R')

#define ERRCODE_DOCUMENTDB_LOCATION51002 MAKE_SQLSTATE('M', '0', '0', 'E', 'S')

#define ERRCODE_DOCUMENTDB_LOCATION4544714 MAKE_SQLSTATE('M', '0', '0', 'E', 'T')

#define ERRCODE_DOCUMENTDB_HOSTUNREACHABLE MAKE_SQLSTATE('M', '0', '0', 'E', 'U')

#define ERRCODE_DOCUMENTDB_AUTHENTICATIONFAILED MAKE_SQLSTATE('M', '0', '0', 'E', 'V')

#define ERRCODE_DOCUMENTDB_LOCKTIMEOUT MAKE_SQLSTATE('M', '0', '0', 'E', 'W')

#define ERRCODE_DOCUMENTDB_EXCEEDEDTIMELIMIT MAKE_SQLSTATE('M', '0', '0', 'E', 'X')

#define ERRCODE_DOCUMENTDB_COMMANDNOTFOUND MAKE_SQLSTATE('M', '0', '0', 'E', 'Y')

#define ERRCODE_DOCUMENTDB_FAILEDTOSATISFYREADPREFERENCE \
	MAKE_SQLSTATE('M', '0', '0', 'E', 'Z')

#define ERRCODE_DOCUMENTDB_SHUTDOWNINPROGRESS MAKE_SQLSTATE('M', '0', '0', 'F', '0')

#define ERRCODE_DOCUMENTDB_WRITECONFLICT MAKE_SQLSTATE('M', '0', '0', 'F', '1')

#define ERRCODE_DOCUMENTDB_CONFLICTINGOPERATIONINPROGRESS \
	MAKE_SQLSTATE('M', '0', '0', 'F', '2')

#define ERRCODE_DOCUMENTDB_CLIENTMETADATACANNOTBEMUTATED \
	MAKE_SQLSTATE('M', '0', '0', 'F', '3')

#define ERRCODE_DOCUMENTDB_CANNOTBUILDINDEXKEYS MAKE_SQLSTATE('M', '0', '0', 'F', '4')

#define ERRCODE_DOCUMENTDB_TRANSACTIONTOOOLD MAKE_SQLSTATE('M', '0', '0', 'F', '5')

#define ERRCODE_DOCUMENTDB_NOSUCHTRANSACTION MAKE_SQLSTATE('M', '0', '0', 'F', '6')

#define ERRCODE_DOCUMENTDB_TRANSACTIONCOMMITTED MAKE_SQLSTATE('M', '0', '0', 'F', '7')

#define ERRCODE_DOCUMENTDB_TOOMANYLOGICALSESSIONS \
	MAKE_SQLSTATE('M', '0', '0', 'F', '8')
...
#define ERRCODE_DOCUMENTDB_NOTARETRYABLEWRITECOMMAND \
	MAKE_SQLSTATE('M', '0', '0', 'F', 'B')
