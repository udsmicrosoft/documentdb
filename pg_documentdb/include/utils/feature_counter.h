...
typedef enum
{
	...
	FEATURE_AGGREGATE_GROUP_COUNT_WITH_ARG,
	...
	FEATURE_CREATE_SEARCH_INDEX_TYPE_SEARCH,
	FEATURE_CREATE_SEARCH_INDEX_TYPE_VECTOR,
	...
	FEATURE_STAGE_GROUP_DUPLICATE_ID,
