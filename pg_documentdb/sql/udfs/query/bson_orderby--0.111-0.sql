...
CREATE OR REPLACE FUNCTION __API_SCHEMA_INTERNAL_V2__.bson_orderby_index(document __CORE_SCHEMA__.bson, filter __CORE_SCHEMA__.bson)
 RETURNS __API_SCHEMA_INTERNAL_V2__.bsonindexterm
 LANGUAGE c
 IMMUTABLE PARALLEL SAFE STRICT
AS 'MODULE_PATHNAME', $function$command_bson_orderby_index$function$;


CREATE OR REPLACE FUNCTION __API_SCHEMA_INTERNAL_V2__.bson_orderby_index(document __CORE_SCHEMA__.bson, filter __CORE_SCHEMA__.bson, collationString text)
 RETURNS __API_SCHEMA_INTERNAL_V2__.bsonindexterm
 LANGUAGE c
 IMMUTABLE PARALLEL SAFE STRICT
AS 'MODULE_PATHNAME', $function$command_bson_orderby_index$function$;

CREATE OR REPLACE FUNCTION __API_SCHEMA_INTERNAL_V2__.bson_orderby_index_reverse(document __CORE_SCHEMA__.bson, filter __CORE_SCHEMA__.bson)
 RETURNS __API_SCHEMA_INTERNAL_V2__.bsonindexterm
 LANGUAGE c
 IMMUTABLE PARALLEL SAFE STRICT
AS 'MODULE_PATHNAME', $function$command_bson_orderby_index_reverse$function$;

CREATE OR REPLACE FUNCTION __API_SCHEMA_INTERNAL_V2__.bson_orderby_index_reverse(document __CORE_SCHEMA__.bson, filter __CORE_SCHEMA__.bson, collationString text)
 RETURNS __API_SCHEMA_INTERNAL_V2__.bsonindexterm
 LANGUAGE c
 IMMUTABLE PARALLEL SAFE STRICT
AS 'MODULE_PATHNAME', $function$command_bson_orderby_index_reverse$function$;
